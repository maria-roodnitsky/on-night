...
import { Linking, StyleSheet, View, Text, Image, FlatList, Dimensions, ImageBackground} from 'react-native';
...
const safetyPoints=[
    ...
    gif: 1,},
  {
    ...
    interacting: [{key: 'More confident, chatty, talkative, animated'}, {key: 'Declining inhibitions and judgement'}, {key: 'Memory beginning to jumble'}, {key: 'Lessening awareness of danger'}, {key: 'Decreasing alertness'}, {key: 'Trouble processing information'}],
    conclusion: "tipsy",
  ...
  },
  {
    ...
    low_male_count: 5,
    high_male_count: 0,
    moving: [ {key: 'Losing most or all control over bodily and motor functions'}, {key: 'Not responding appropriately to stimuli'}, {key: 'Unable to stand or walk'}, {key: 'Vomiting'}, {key: 'Trouble breathing'}, {key: "Gag reflex not working appropriately"}, {key: "Unresponsive or completely passed out"}, {key: "Seizures"}, {key: "Blue or pale skin"}],
    interacting: [{key: "Emotionally unstable and disoriented"},{key: "Dizzy"}, {key: "Memory lapses (blacking out) where they are not quite passed out but operating as a walking, talking, zombie on autopilot"}, {key: "Much higher pain tolerance"}, {key: 'Emotional outbursts and confusion'}],
