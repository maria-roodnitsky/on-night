...
import {
  Text, Platform, View, SafeAreaView, StyleSheet, ScrollView, ImageBackground, TouchableOpacity, Dimensions, KeyboardAvoidingView,
} from 'react-native';
...
class EditProfile extends Component {
  ...
  componentDidMount() {
    this.setState({ name: this.props.user.name, year: this.props.user.classYear });
        ...
        >
          <ScrollView style={styles.container}>
            ...
            <View style={{ display: 'flex', flexDirection: 'row' }}>
              ...
              {!this.state.editingName && (
              <TouchableOpacity style={styles.smallButtonContainer} onPress={() => { this.toggleNameEdit(); }}>
            ...
            <View style={{ display: 'flex', flexDirection: 'row' }}>
              ...
              {!this.state.editingYear && (
              <TouchableOpacity style={styles.smallButtonContainer} onPress={() => { this.toggleYearEdit(); }}>
                <Text style={styles.smallButtonText}>edit</Text>
              </TouchableOpacity>
              )}
              {this.state.editingYear && (
            ...
            <View style={{ display: 'flex', flexDirection: 'row' }}>
              ...
              {!this.state.editingGender && (
              <TouchableOpacity style={styles.smallButtonContainer} onPress={() => { this.toggleGenderEdit(); }}>
                <Text style={styles.smallButtonText}>edit</Text>
              </TouchableOpacity>
              )}
              {this.state.editingGender && (
