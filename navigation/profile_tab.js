...
import {
  Text, View, SafeAreaView, StyleSheet, ImageBackground, Dimensions,
} from 'react-native';
    ...
    if ((this.state.users == null || this.state.events == null || this.state.user == null) && this.state.problemLoading == false) {
      ...
      return (
        <Stack.Navigator>
          ...
          >
            {(props) => <OrgEvents {...props} reRender={this.reRender} user={this.state.user} events={this.state.events} />}
          </Stack.Screen>
          <Stack.Screen
            name="NewEvent"
            options={{
